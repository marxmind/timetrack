...
public class EmployeePosition {
	...
	public static List<EmployeePosition> retrieve(String sql, String[] params){
		List<EmployeePosition> poss = new ArrayList<>();
	...
	public static EmployeePosition save(EmployeePosition pos){
		if(pos!=null){
			LogU.open();
			long id = EmployeePosition.getInfo(pos.getId() ==0? EmployeePosition.getLatestId()+1 : pos.getId());
			LogU.add("checking for new added data");
			if(id==1){
				LogU.add("insert new Data ");
				pos = EmployeePosition.insertData(pos, "1");
			}else if(id==2){
				LogU.add("update Data ");
				pos = EmployeePosition.updateData(pos);
			}else if(id==3){
				LogU.add("added new Data ");
				pos = EmployeePosition.insertData(pos, "3");
			}
	...
	public static EmployeePosition insertData(EmployeePosition pos, String type){
	...
	public static EmployeePosition updateData(EmployeePosition pos){
